...
public class ThemeDescriptionTest {
  ...
  public void testCostumeDescription() throws IOException {
    ...
    CostumeDescription cd2 =
        (new ObjectMapper()).readValue(new File("data/test.json"), CostumeDescription.class);
  ...
  public void testThemeDescription() throws IOException {
    ...
    costumes.put(
        "pacman",
        new CostumeDescription("themes/classic/images/pacman.png", true, 1.0, true, true));
    ...
    ThemeDescription td =
        new ThemeDescription("demo", new HashMap<>(), costumes, "themes/classic" + "/theme.css");
