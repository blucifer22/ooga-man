...
public interface GameStateObservable {
  ...
  /**
   * Get a list of all players for this Pac-Man mode. Each player provides access to a player ID and
   * score. If applicable to the game-mode, the first Player corresponds to the player controlling
   * Pac-Man.
   *
