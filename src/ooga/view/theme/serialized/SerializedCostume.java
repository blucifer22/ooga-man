...
/**
 * Primary data container for {@link SerializedTheme}. A {@link SerializedTheme} provides a
 * {@link SerializedCostume} in response to a
 * {@link SerializedTheme#getCostumeForObjectOfType(String)} call; any visual object with a
...
public class SerializedCostume implements Costume {
  ...
  /**
   * Instantiates a {@link SerializedCostume} from a {@link CostumeDescription} (the
   * {@link SerializedCostume}'s JSON-deserialized form).
   *
