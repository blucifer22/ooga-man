 ...
 * (usually indirectly, through a {@link ooga.view.uiservice.UIServiceProvider}'s {@link
 * ThemeService}) referencing view to query for {@link Media}, {@link Costume}s, and stylesheets.
 *
