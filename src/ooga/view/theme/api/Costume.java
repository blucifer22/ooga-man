...
/**
 * Primary data container for {@link Theme}. A {@link Theme} provides a {@link Costume} in response
 * to a {@link Theme#getCostumeForObjectOfType(String)} call; any visual object with a {@link
 * String}-equivalent notion of "type" can thus be themed, should a front-end decide to use themes
 * as provided in the {@link ooga.view.theme} package.
 *
