 ...
 * object to store its translations; for example, a {@link javafx.scene.control.Label} could set
 * its label according to a certain localized String with resource bundle key "TEST", instead of
 * accessing a resource bundle directly, it would do the following:
 *
 * <code>
 *   LanguageService ls = ...;
 *   Label myTestLabel = new Label();
 *   myTestLabel.textProperty().bind(ls.getLocalizedString("test"));
 * </code>
 *
